...
// Import all modular panels from C:\JadioAI\IDE\src\
mod backend;
mod codeagent;
mod codeagentactivitybar;
mod dropdownmenu;
mod editor;
mod explorer;
mod exploreractivitybar;
mod searchbar;
mod specialbuttonsbar;
mod statusbar;
mod terminal;

use codeagent::CodeAgent;
use codeagentactivitybar::CodeAgentActivityBar;
use dropdownmenu::DropdownMenu;
use editor::Editor;
use explorer::Explorer;
use exploreractivitybar::ExplorerActivityBar;
use searchbar::SearchBar;
use specialbuttonsbar::SpecialButtonsBar;
